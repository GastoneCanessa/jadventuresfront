...
export default function AllQuests()
{
    ...
    function isShowable(q,minR,maxR,typ,stat,mRew,are)
    {
        ...
        if (minR.toUpperCase() !== "A" && minR.toUpperCase() !== "S" && minR.toUpperCase() !== "B" && minR.toUpperCase() !== "C" && minR.toUpperCase() !== "D")
            return false;

        if (maxR.toUpperCase() !== "A" && maxR.toUpperCase() !== "S" && maxR.toUpperCase() !== "B" && maxR.toUpperCase() !== "C" && maxR.toUpperCase() !== "D")
            return false;
    ...
    return(
        <div className="row">
            <div className="col-6 border border-black">
                <div className="sticky-top bg-dark col col-lg-4" style={{ height: "30vh", top: "100px" }}>
                    ...
                    <div className="input-group mb-3" >
                        <label for="y" className="fw-bold form-label me-2" style={{ color: "white" }}>Insert min rank:</label> <br />
                    ...
                    <div className="input-group mb-3" >
                        <label for="y" className="fw-bold form-label me-2" style={{ color: "white" }}>Insert max rank:</label> <br />
                    ...
                    <div>
                        ...
                        <div className="input-group mb-3" >
                            <label for="y" className="fw-bold form-label me-2" style={{ color: "white" }}>Insert max reward:</label> <br />
                        ...
                        <div className="input-group mb-3" >
                            <label for="y" className="fw-bold form-label me-2" style={{ color: "white" }}>Insert area:</label> <br />
                        ...
                        <div className="input-group mb-3" >
                            <label for="y" className="fw-bold form-label me-2" style={{ color: "white" }}>Insert status:</label> <br />
                        ...
                        <button type="button" class="btn btn-primary" onClick={() => setFlicker(!flicker)} >Filtra</button>
                    </div>
                </div>
                <div className="col-6 border border-black">
                    {/* <div className="row">
